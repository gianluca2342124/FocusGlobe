...
enum PaywallContext: Equatable {
    ...
    case rewards          // Store ▸ Get Coins:  "Earn 2× Coins"
    ...
    var benefitTitle: String {
        ...
        case .rewards:     return "Earn 2× Coins"
    ...
    var supportingCopy: String {
        ...
        case .rewards: return "Get twice the Coins from every completed journey with PRO."
