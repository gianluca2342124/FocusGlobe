...
struct WidgetGalleryItem: Identifiable {
    ...
    static let all: [WidgetGalleryItem] = [
        ...
        .init(id: "FGStartJourney", name: "Start a Journey",
              blurb: "Depart from your city and begin a focus flight in one tap.",
              systemImage: "paperplane.fill", glow: WGTheme.gold,
              families: ["Small", "Medium", "Large"], isPro: false),
        .init(id: "FGCurrentJourney", name: "Current Journey",
              blurb: "Resume an unfinished journey, shown on a live map.",
        ...
        .init(id: "FGLongestRoute", name: "Longest Route",
              blurb: "Your longest completed focus journey.",
