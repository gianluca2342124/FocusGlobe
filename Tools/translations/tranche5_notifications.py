...
TRANSLATIONS: dict[str, list[str]] = {
    ...
    "Pick up the route you started whenever you're ready.": [
        "准备好了就接着走你开始的航线。",
        "जब तैयार हों, शुरू किया रास्ता फिर से पकड़ें।",
    ...
    "Open your daily gift before it flies away.": [
        ...
        "Abre tu regalo diario antes de que se vuele.",
    ...
    "Ready for another quiet flight?": [
        ...
        "¿Listo para otro vuelo tranquilo?", "Prêt pour un autre vol paisible ?",
        "Bereit für einen weiteren ruhigen Flug?",
        "Готовы к ещё одному тихому полёту?",
        "Pronto para outro voo tranquilo?",
        "Pronto per un altro volo tranquillo?",
    ...
    "Ready for one focused expedition?": [
        "准备好一次专注的远征了吗？", "एक फ़ोकस्ड यात्रा के लिए तैयार?",
        "¿Listo para una expedición concentrada?",
        "Prêt pour une expédition concentrée ?",
        "Bereit für eine fokussierte Expedition?",
        "Готовы к одной сосредоточенной экспедиции?",
        "Pronto para uma expedição focada?",
        "Pronto per una spedizione concentrata?",
        "Gata pentru o expediție concentrată?",
        "Klaar voor één gefocuste expeditie?",
    ],
    "One focused drift before the day ends?": [
        "在今天结束前，来一次专注的漂流？",
        "दिन ख़त्म होने से पहले एक फ़ोकस्ड उड़ान?",
        "¿Una deriva concentrada antes de que acabe el día?",
        "Une dérive concentrée avant la fin de la journée ?",
        "Ein fokussierter Flug, bevor der Tag endet?",
        "Один сосредоточенный полёт до конца дня?",
        "Um voo focado antes de o dia acabar?",
        "Una planata concentrata prima che finisca il giorno?",
        "O plutire concentrată înainte să se termine ziua?",
    ...
    "Your next deep-work block awaits": [
        ...
        "Seu próximo bloco de trabalho profundo espera",
    ...
    "One short expedition keeps your focus streak alive.": [
        ...
        "Une courte expédition garde votre série de concentration en vie.",
    ...
    "Set off on one short session and keep your streak alive.": [
        "出发一次短暂的专注，延续你的连续天数。",
        "एक छोटा सत्र शुरू करें और अपनी स्ट्रीक बनाए रखें।",
        "Sal a una sesión corta y mantén viva tu racha.",
        "Partez pour une courte session et gardez votre série en vie.",
        "Starte eine kurze Sitzung und halte deine Serie am Leben.",
        "Отправьтесь в короткую сессию и сохраните серию.",
        "Saia para uma sessão curta e mantenha sua sequência viva.",
    ...
    "Pick a destination and give yourself 25 minutes.": [
        ...
        "Alege o destinație și dăruiește-ți 25 de minute.",
    ...
    "Complete one expedition today and keep your momentum.": [
        ...
        "Завершите одну экспедицию сегодня и сохраните разгон.",
    ...
    "Your journal is missing today's stamp.": [
        "你的日志还缺今天的印章。",
        "आपकी डायरी में आज की मुहर बाक़ी है।",
    ...
    "One focused session before distractions win.": [
        "在分心占上风前，来一次专注的专注。",
        "ध्यान भटकने से पहले एक फ़ोकस्ड सत्र।",
    ...
    "Come back for one calm focus trip.": [
        ...
        "Возвращайтесь за спокойным путешествием фокуса.",
...
PLURALS: dict[str, dict[str, dict[str, str]]] = {
    "Your %lld-day streak is waiting 🔥": {
        ...
        "de": {"one": "Deine %lld-Tage-Serie wartet 🔥",
