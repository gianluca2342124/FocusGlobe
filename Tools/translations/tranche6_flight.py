...
TRANSLATIONS: dict[str, list[str]] = {
    ...
    "Settle in and breathe": [
        ...
        "Mettiti comodo e respira", "Așază-te comod și respiră",
        "Ga zitten en adem",
    ],
    ...
    "Almost there — keep going": [
        ...
        "Presque arrivé — continuez", "Fast da — weiter so",
    ...
    "Crew flight": [
        "机组飞行", "क्रू फ़्लाइट", "Vuelo en tripulación", "Vol en équipage",
        "Crew-Flug", "Полёт с командой", "Voo em tripulação",
        "Volo con equipaggio", "Zbor cu echipaj", "Crewvlucht",
    ],
    "Checked in.": [
        "已登记。", "चेक-इन हो गया।", "Registrado.", "Enregistré.",
        "Eingecheckt.", "Регистрация пройдена.", "Check-in feito.",
        "Check-in effettuato.", "Check-in făcut.", "Ingecheckt.",
    ],
    "Not checked in.": [
        "尚未登记。", "चेक-इन नहीं हुआ।", "Sin registrar.", "Non enregistré.",
    ...
    "CHECK IN": [
        "登机", "चेक-इन", "FACTURAR", "ENREGISTREMENT",
        "EINCHECKEN", "РЕГИСТРАЦИЯ", "CHECK-IN", "CHECK-IN",
        "CHECK-IN", "INCHECKEN",
    ],
    "My Expedition Page": [
        "我的远征页", "मेरा एक्सपीडिशन पेज", "Mi página de expedición",
    ...
    "Time Focused": [
        "已专注时长", "फ़ोकस समय", "Tiempo concentrado", "Temps de concentration",
        "Fokussierte Zeit", "Время в фокусе", "Tempo focado",
        "Tempo di concentrazione", "Timp de concentrare", "Gefocuste tijd",
    ],
    "Time Remaining": [
    ...
    "Cozy up inside": [
        ...
        "Устройтесь уютно внутри", "Fique aconchegado lá dentro",
        "Mettiti comodo dentro", "Fă-te comod înăuntru",
    ...
    "You’ll leave the room": [
        ...
        "Vous quitterez la salle", "Du verlässt den Raum", "Вы покинете комнату",
    ...
    "Pick a route. Stay focused until you land.": [
        ...
        "Choisissez un itinéraire. Restez concentré jusqu’à l’atterrissage.",
        ...
        "Scegli una rotta. Resta concentrato fino all’atterraggio.",
        "Alege o rută. Rămâi concentrat până aterizezi.",
    ...
    "Great start — come back tomorrow to keep it alive.": [
        ...
        "Bon début — revenez demain pour la garder en vie.",
